...
async function test() {
  ...
  const fundingRate = await funding.callStatic.fundingRate("0xc32a2dfee97e2babc90a2b5e6aef41e789ef2e13", 0)
  console.log("fundingRate: ", fromWei(fundingRate.toString()))
  const unitAccumulativeFunding = await funding.callStatic.unitAccumulativeFunding("0xc32a2dfee97e2babc90a2b5e6aef41e789ef2e13", 0)
